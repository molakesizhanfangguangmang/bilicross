...
class AppLocalizationsEn extends AppLocalizations {
  ...
  static const Map<String, String> data = {
    ...
    'manifest.preflight.bestAvailable': 'up to {quality}',
    'manifest.missingQualitySummary':
        '{count} episodes lack your chosen quality; each shows its best available',
    'manifest.jumpToFirst': 'Jump to first',
    'manifest.overrideQuality': 'Change',
    'manifest.overrideQualitySet': 'Quality {quality}',
    'manifest.overrideQualityTitle': 'Quality for this episode only',
    'manifest.overrideQualityClear': 'No override (use best available)',
    ...
    'download.videoStreamsPart': 'Video streams · P{page}/{total}',
    'download.pickPageAction': 'Parts',
    ...
    'tasks.sectionPause': 'Pause this section',
    'tasks.sectionStop': 'Stop this section',
    'tasks.sectionRetry': 'Retry this section',
    'tasks.cleanResidue': 'Clean leftovers',
    'tasks.cleanResidueDone': 'Removed {count} leftover files ({tasks} tasks)',
    'tasks.clearAll': 'Clear list',
    'tasks.clearAllConfirm': 'Clear all {count} task records? Downloaded files are kept.',
    'tasks.clearRecordsOnly': 'Records only',
    'tasks.clearWithFiles': 'Also delete leftovers',
    ...
    'settings.navStyle.bounce': 'Bounce',
    'settings.navStyle.dock': 'Dock',
