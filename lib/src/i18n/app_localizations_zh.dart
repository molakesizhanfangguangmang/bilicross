...
class AppLocalizationsZh extends AppLocalizations {
  ...
  static const Map<String, String> data = {
    ...
    'manifest.preflight.bestAvailable': '最高 {quality}',
    'manifest.missingQualitySummary': '{count} 集没有你选的档，各集已标出最高可用档位',
    'manifest.jumpToFirst': '跳到第一处',
    'manifest.overrideQuality': '改档位',
    'manifest.overrideQualitySet': '档位 {quality}',
    'manifest.overrideQualityTitle': '这一集单独用哪个档位？',
    'manifest.overrideQualityClear': '不单独设置（用实际最高档）',
    ...
    'download.videoStreamsPart': '视频流 · P{page}/{total}',
    'download.pickPageAction': '选集',
    ...
    'download.enqueuedWait': '已加入任务队列，去「任务」页点全部开始',
    ...
    'tasks.sectionPause': '暂停这一段',
    'tasks.sectionStop': '终止这一段',
    'tasks.sectionRetry': '重试这一段',
    'tasks.cleanResidue': '清理残留文件',
    'tasks.cleanResidueDone': '已清理 {count} 个残留文件（{tasks} 条任务）',
    'tasks.clearAll': '清空列表',
    'tasks.clearAllConfirm': '清空全部 {count} 条任务记录？已下载完成的成品不会被删除。',
    'tasks.clearRecordsOnly': '只删记录',
    'tasks.clearWithFiles': '连残留文件一起删',
    ...
    'settings.navStyle.bounce': '弹跳',
    'settings.navStyle.dock': '胶囊',
    'settings.network': '网络',
    'settings.proxy': '代理',
    ...
    'backup.passphraseSetTitle': '设置备份口令',
    'backup.passphraseSetHint':
        '这份备份用这个口令加密。口令丢了备份就打不开，软件不会保存它，请自己记牢。',
    'backup.passphraseAskTitle': '输入备份口令',
    'backup.passphraseAskHint': '这份备份受口令保护，请输入导出时设置的那个口令。',
    'backup.passphraseTooShort': '口令至少 {count} 位',
